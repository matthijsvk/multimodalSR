...
from resnet50CaffeToLasagne import *
...
# python resnet50_evaluateNetwork.py -i indianElephant.jpeg -m resnet50imageNet.pkl -> gives the 5 most probable classes of the image 'indianElephant.jpeg'
