...
# with CNN: 'THEANO_FLAGS=floatX=float32,device=gpu,nvcc.flags=-D_FORCE_INLINES,optimizer=fast_compile python mnist_example.py cnn 10'
#   -> 90.70%, 23s -> 95.13%, 22.3s -> 96.16%, 23s -> ... -> (epoch 10): 
