...
def main():
    ...
    networkList = [
        ...
        networkToTrain(cnn_features="conv",  LIP_RNN_HIDDEN_LIST=None, DENSE_HIDDEN_LIST=[512]),
        networkToTrain(cnn_features="conv", LIP_RNN_HIDDEN_LIST=None, DENSE_HIDDEN_LIST=[512,512]),

        networkToTrain(cnn_features="dense", LIP_RNN_HIDDEN_LIST=None, DENSE_HIDDEN_LIST=[512, 512, 256], datasetType="volunteers", forceTrain=True),
        networkToTrain(cnn_features="conv",  LIP_RNN_HIDDEN_LIST=None, DENSE_HIDDEN_LIST=[512, 512, 256],  datasetType="volunteers",forceTrain=True)
    ]
...
class networkToTrain:
    def __init__(self,
        ...
        self.cnn_features           = cnn_features              # conv or dense: output features of lipreading that are passed to the combination network
