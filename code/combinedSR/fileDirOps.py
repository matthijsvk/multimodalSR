    ...
    for frame in validFrames.keys():
        for phoneme in validFrames[frame]:
            ...
            if not os.path.exists(newFilePath): #if already exists, do nothing
                ...
                except: return videoDir; #import pdb;pdb.set_trace() #return videoDir #frame not found, means something went wrong in the extraction -> delete dir and extract again
