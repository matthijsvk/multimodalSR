...
logging.setLoggerClass(formatting.ColoredLogger)
...
X_train_all, y_train_all = preprocessWavs.preprocess_dataset(source_path=train_source_path, logger=logger, debug=debug_size)
