...
from phoneme_set import phoneme_set_39_list, phoneme_set_61_list
...
### store path
target = os.path.join(outputDir, os.path.basename(dataRootDir) + '_26_ch');
...
# set log file
logFile = outputDir + os.sep + os.path.basename(dataRootDir) + '.log'
