...
import lasagne
from lasagne.layers import InputLayer, DenseLayer, RecurrentLayer, NonlinearityLayer, ReshapeLayer, get_output, \
    get_all_params, get_all_param_values, ElemwiseSumLayer
import ctc_cost
